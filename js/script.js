const menu = [
  ...
  const createButtons = () =>{
    ...
    <button id="korean" class="btn btn-outline-dark btn-item" type="button">
    Korean
    </button>
    <button id="japanese" class="btn btn-outline-dark btn-item" type="button">
    Japanese
    </button>
    <button id="chinese" class="btn btn-outline-dark btn-item" type="button">
    Chinese
    </button>`
...
const listJapaneseFoods = () => {
  ...
  menuSection.innerHTML = japaneseFoods;
}
document.querySelector("#japanese").addEventListener("click",listJapaneseFoods);
